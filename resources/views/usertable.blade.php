    ...
    <div class="be-wrapper">
      <nav class="navbar navbar-expand fixed-top be-top-header">
        ...
        <div class="be-navbar-header"><a style="line-height: 60px;
                                                  ...
                                                  margin: 0;
                                                  display: block;
                                                  font-size: 24px" href="{{URL::to('/')}}">TravelGO</a>
          </div>
                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Thêm thông tin</span></a>
                    <ul class="sub-menu">
                      ...
                      <li><a href="{{URL::to('/adduser')}}">Thêm user</a>
                      </li>
                      <li><a href="{{URL::to('/addflight')}}">Thêm Booking chuyến bay</a>
                      </li>
                      <li><a href="{{URL::to('/addhotelbooking')}}">Thêm Booking Khách Sạn</a>
                      </li>
                      <li><a href="{{URL::to('/addcar')}}">Thêm Booking Car</a>
                      </li>
                    </ul>
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-border-all"></i><span>Quản lý thông tin</span></a>
                    <ul class="sub-menu">
                      ...
                      <li><a class="active" href="{{URL::to('/showusers')}}">User</a>
                      </li>
                      <li><a href="{{URL::to('/showhotel')}}">Booking Hotel</a>
                      </li>
                      <li><a href="{{URL::to('/showflight')}}">Booking Flight</a>
                      </li>
                      <li><a href="{{URL::to('/showcar')}}">Booking Car</a>
                      </li>
      ...
      <div class="be-content">
        ...
        <div class="main-content container-fluid">
          <div class="row">
            ...
            <div  style= "-webkit-box-flex: 0; flex: 0 0 100, max-width: 100%; display:flex ; ">
              <div class="card card-table " style="padding-right: 200px;">
                <div class="card-header">Tài khoản người dùng
                  ...
                  <table class="table" style = >
                    ...
                    @foreach($user as $key => $user)
                      <tr>
                        ...
                        <td>{{$user->email}}</td>
                        <td>{{ $user->phone }}></td>
                        <td class="actions"><a class="icon"  href="{{URL::to('/showusers/'.$user->id)}}"><i class="mdi mdi-delete"></i></a></td>
                      </tr>
                      </tr>
                      @endforeach
                  ...
                  <table class="table" style="width: 500px">
                    <thead>
                      <tr>
                        ...
                        <th style="width:50px">Tên khách sạn</th>
                        <th style="width:30%;">Hình ảnh</th>
                        <th style="width:13%;">Số người lớn</th>
                        <th style="width:10%;">Trẻ em</th>
                        <th style="width:10%;">Người Bắt Đầu</th>
                        <th style="width:10%;">Người Kết thúc</th>
                        <th style="width:10%;">Giá/ngày</th>
                        <th class="actions"></th>
                      </tr>
                    </thead>
                    <tbody>
                    @foreach($cart as $key => $cart)
                      <tr>
                        <td>{{$cart->id}}</td>
                        <td>{{$cart->name}}</td>
                        <td><img src="{{ $cart->image }}" width= "200px" height= "80px "></td>
                        
                        <td>{{$cart->adult}}</td>
                        <td>{{ $cart->children }}</td>
                        <td>{{ $cart->start_date }}</td>
                        <td>{{ $cart->end_date }}</td>
                        <td>{{ $cart->new_price*$cart->adult+ $cart->children*$cart->new_price/2}}</td>
                        <td class="actions"><a class="icon"  href="{{URL::to('/cart/'.$user->id)}}"><i class="mdi mdi-delete"></i></a></td>
                      </tr>
                      </tr>
                      @endforeach
